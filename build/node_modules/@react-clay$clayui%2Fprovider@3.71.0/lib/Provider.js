...
Liferay.Loader.define("@react-clay$clayui/provider@3.71.0/lib/Provider", ['module', 'exports', 'require', '@react-clay$clayui/icon', 'react-clay$react', './DataClient'], function (module, exports, require) {
  ...
  var global = window;
  {
    ...
    var _icon = require("@react-clay$clayui/icon");

    var _react = _interopRequireWildcard(require("react-clay$react"));
